...
$(document).ready(function(){
    ...
    document.getElementById("header").innerHTML='<object type="text/html" data="/portfolio/include/header.html"></object>';
    document.getElementById("footer").innerHTML='<object type="text/html" data="/portfolio/include/footer.html"></object>';
...
function timeStamp() {
    ...
    value = hour + " : " + minute + " : " + second + " "+ flag; 

    $(".time")[0].innerText = value;
}
